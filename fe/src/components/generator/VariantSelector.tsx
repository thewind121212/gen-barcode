...
import { Tag, Settings, Plus, Hash, RefreshCw } from 'lucide-react';
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 relative overflow-hidden">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
                <p className="text-xs text-gray-400 mb-2">Hoặc nhập mã thủ công / Random:</p>
                <div className="flex gap-3">
                    <div className="relative flex-1">
                        <input
                            ...
                            placeholder="00001"
                            className="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 font-mono text-lg tracking-wider"
                        />
